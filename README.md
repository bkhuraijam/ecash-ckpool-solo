...
Update: I have dockerised all required services ; ecash-node, ecash-solo-ckpool, postgesql (database) and ckstats (web ui). Its configured the the docker-compose.yml included. You can just tweak a little as per your desire and requirements and you can have a locally hosted ecash solo mining pool with web ui to motnitor stats.
